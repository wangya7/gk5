package wang.bannong.gk5.offer.netty.chat.protocol;
 ...
 * 自定义IM协议的解码器
 * <p>
 * 注意ByteToMessageDecoder解码器没有考虑TCP半包和粘包的问题，需要自己解决
 */
public class IMDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        try {
            ...
            IMMessage imMessage = new MessagePack().read(array, IMMessage.class);
            out.add(imMessage);
            in.clear();
