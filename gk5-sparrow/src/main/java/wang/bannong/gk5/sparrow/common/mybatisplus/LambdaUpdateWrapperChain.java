package wang.bannong.gk5.sparrow.common.mybatisplus;
 ...
 * Lambda修改Wrapper
 */
public class LambdaUpdateWrapperChain<T> extends AbstractChainWrapper<T, SFunction<T, ?>, LambdaUpdateWrapperChain<T>, LambdaUpdateWrapper<T>>
