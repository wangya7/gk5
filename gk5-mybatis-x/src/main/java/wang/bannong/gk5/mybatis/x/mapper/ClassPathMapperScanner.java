 ...
 * annotationClass}, or
 * {@code markerInterface}. If an {@code annotationClass} and/or {@code markerInterface} is
 * specified, only the
...
public class ClassPathMapperScanner extends ClassPathBeanDefinitionScanner {
    ...
    protected boolean checkCandidate(String beanName, BeanDefinition beanDefinition) {
        if (super.checkCandidate(beanName, beanDefinition)) {
            ...
            log.warn("Skipping MapperFactoryBean with name '{}' and '{}' mapperInterface. Bean " +
                    "already defined with the same name!", beanName, beanDefinition.getBeanClassName());
            return false;
        }
    }
